...
export const CreateCriticalHitTable: React.FC = () => {
  ...
  const [leftTorso, setLeftTorso] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "", seven: "", eight: "", nine: "", ten: "", eleven: "", twelve: "" });
  const [leftLeg, setLeftLeg] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "" });
  const [head, setHead] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "" });
  const [centerTorso, setCenterTorso] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "", seven: "", eight: "", nine: "", ten: "", eleven: "", twelve: "" });
  const [rightArm, setRightArm] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "", seven: "", eight: "", nine: "", ten: "", eleven: "", twelve: "" });
  const [rightTorso, setRightTorso] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "", seven: "", eight: "", nine: "", ten: "", eleven: "", twelve: "" });
  const [rightLeg, setRightLeg] = useState<CriticalHitTableType>({ one: "", two: "", three: "", four: "", five: "", six: "" });
