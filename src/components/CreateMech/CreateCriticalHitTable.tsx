...
import { CreateCriticalHitTableModal } from "./CreateMechModals/CreateCriticalHitTableModal";
...
export const CreateCriticalHitTable: React.FC<CreateCriticalHitTableProps> = ({ id, mechInfo }) => {
  ...
  return (
    <div className="grid grid-cols-38 grid-rows-47 w-full h-full">
      ...
      <CreateCriticalHitTableModal modal={modal} input={input} handleInput={handleInput} handleChange={handleChange} handleValue={handleValue} closeModal={closeModal} saveModal={saveModal}/>
