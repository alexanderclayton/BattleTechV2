    ...
    <div className="w-full h-full">
      ...
      {displayImage === "" ? (
        <>
          ...
          <div
            onClick={toggleModal}
            className="flex col-start-4 col-end-15 row-start-10 justify-center items-center hover:cursor-pointer"
          >
        ...
        <>
          ...
          <div className="h-[15%] flex justify-around mt-2">
            <div
              onClick={toggleModal}
              className="flex flex-col items-center bg-yellow-400 rounded-lg p-1 hover: cursor-pointer"
            >
              <GoPlusCircle />
            ...
            <div
              onClick={deleteImage}
              className="flex flex-col items-center bg-red-400 rounded-lg p-1 hover: cursor-pointer"
            >
