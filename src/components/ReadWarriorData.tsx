...
export const ReadWarriorData: React.FC<WarriorDataProps> = ({ mechData }) => {
    return (
      <div className="grid grid-cols-16 grid-rows-9 w-full h-full">
          ...
          <p className="col-start-5 col-end-16 row-start-3 row-end-4 border-b border-black text-2xs pl-2">{mechData[0].name}</p>
          <p className="col-start-2 col-end-7 row-start-4 row-end-5 text-2xs font-bold">Gunnery Skill:</p>
          <p className="col-start-7 col-end-9 row-start-4 row-end-5 border-b border-black text-2xs text-center">{mechData[0].gunnerySkill}</p>
          <p className="col-start-9 col-end-14 row-start-4 row-end-5 text-2xs font-bold text-right">Piloting Skill:</p>
          <p className="col-start-14 col-end-16 row-start-4 row-end-5 border-b border-black text-2xs text-center">{mechData[0].pilotingSkill}</p>
          ...
          <p className="col-start-8 col-end-9 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">3</p>
          <p className="col-start-9 col-end-10 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">5</p>
          <p className="col-start-10 col-end-11 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">7</p>
          <p className="col-start-11 col-end-12 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">10</p>
          <p className="col-start-12 col-end-13 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">11</p>
          <p className="col-start-13 col-end-15 row-start-7 row-end-8 border border-black text-2xs font-bold flex justify-center items-center">Dead</p>
      </div>
    )
  }