...
export const WarriorData: React.FC = () => {
  return (
    <div className="grid grid-cols-16 grid-rows-9 w-full h-full">
        ...
        <p className="col-start-5 col-end-16 row-start-3 row-end-4 border-b border-black text-2xs pl-2">string</p>
        <p className="col-start-2 col-end-7 row-start-4 row-end-5 text-2xs font-bold">Gunnery Skill:</p>
        <p className="col-start-7 col-end-9 row-start-4 row-end-5 border-b border-black text-2xs text-center">0</p>
        <p className="col-start-9 col-end-14 row-start-4 row-end-5 text-2xs font-bold text-right">Piloting Skill:</p>
        <p className="col-start-14 col-end-16 row-start-4 row-end-5 border-b border-black text-2xs text-center">0</p>
